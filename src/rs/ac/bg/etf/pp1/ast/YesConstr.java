...
public class YesConstr extends YesConstructor {

    private ConstructorDecl ConstructorDecl;
    private MethodDecl MethodDecl;
    private MethodDeclList MethodDeclList;

    public YesConstr (ConstructorDecl ConstructorDecl, MethodDecl MethodDecl, MethodDeclList MethodDeclList) {
